...
const dict = {
  he: {
    ...
    // Dashboard
    pickGame: 'בְּחַר מִשְׂחָק וּבוֹא נַתְחִיל!',
    pickSub: 'כָּל מִשְׂחָק מְאַמֵּן יְכֹלֶת אַחֶרֶת',
    mockExamCta: 'מִבְחָן סִימוּלַצְיָה',
    mockExamSub: '10 שְׁאֵלוֹת כְּמוֹ בַּמִּבְחָן הָאֲמִיתִּי 🎓',
    ...
    hintBtn: 'רֶמֶז',
    explainBtn: 'הֶסְבֵּר',
    speakBtn: 'הַקְרֵא בְּקוֹל',
    level: 'רמה',
    levelUp: 'עָלִיתָ רָמָה!',
    streakHot: 'שִׁילּוּב חַם!',
    great: 'כָּל הַכָּבוֹד',
    amazing: 'מַדְהִים!',
    tryAgain: 'נְנַסֶּה שׁוּב?',
    readDirRtl: 'קְרָא מִיָּמִין לִשְׂמֹאל ←',
    readDirLtr: '→ קְרָא מִשְּׂמֹאל לְיָמִין',
    rtlAria: 'כיוון קריאה: מימין לשמאל',
    ltrAria: 'כיוון קריאה: משמאל לימין',
    questionOf: 'שאלה {n} מתוך {total}',

    // Results
    starsEarned: 'קִבַּלְתָּ {n} כּוֹכָבִים!',
    newCollectible: 'פְּרִיט חָדָשׁ בָּאוֹסֶף!',
